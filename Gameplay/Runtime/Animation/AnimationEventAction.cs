...
namespace Gameplay.Runtime {
    ...
    public class AnimationEventAction {
        ...
        [Required, ShowIf("@instantiator")]
        public GameObject prefab;
        [Required, ShowIf("@instantiator")]
        [InfoBox("Should never be null, because we copy the parents position and rotation on start")]
        ...
        public void InstantiateObject() {
            if(!instantiator || prefab == null || parent == null) return;
